...
{
    public class DynamicSliceOutput : SliceOutput
    {
        ...
        {
            _slice = new Slice(estimatedSize);
        }
        ...
        {
            _slice = Slices.EnsureSize(_slice, _size + SizeOf.Byte);
        ...
        {
            _slice = Slices.EnsureSize(_slice, _size + SizeOf.Short);
        ...
        {
            _slice = Slices.EnsureSize(_slice, _size + SizeOf.Int);
        ...
        {
            _slice = Slices.EnsureSize(_slice, _size + SizeOf.Long);
        ...
        {
            _slice = Slices.EnsureSize(_slice, _size + length);
        ...
        public override void WriteZero(uint length)
        {
            ...
            _slice = Slices.EnsureSize(_slice, (int) (_size + length));
            var nLong = length >> 3;
            var nBytes = length & 7;
