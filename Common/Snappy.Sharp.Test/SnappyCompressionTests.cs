...
namespace Snappy.Sharp.Test
{
    public class SnappyCompressionTests
    {
        ...
        {
            // 1024 a's
			var data = Encoding.ASCII.GetBytes(""); 
        ...
        {
            var data = Encoding.ASCII.GetBytes("ThisThisThisThisThisThisThisThisThisThisThisThisThisThisThisThisThisThisThisThisThisThisThisThisThis"); 
            var target = new SnappyCompressor();
